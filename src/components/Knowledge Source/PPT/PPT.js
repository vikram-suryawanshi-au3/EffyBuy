            ...
            <div className="ppt_main_div container">
                <div className="ppt_individual_card">
                    ...
                    <div className="ppt_individual_card_desc">
                        Detailed view on the solutions and its usage to the customers and their suppliers. 
                        This is a very helpful document that can educate you on the inputs reuqired
                    </div>
                            ...
                            <Modal.Body>
                                <div className="ppt_modal_description">
                                    ...
                                    <div className="ppt_modal_description_points">
                                        <ul>
                                            <li>
                                                Insights on the how EffyBuy supports your adoption of 
                                                advanced technology and gives your business a competitive edge to grow profits
                                            </li>
                                            {/* <li>
